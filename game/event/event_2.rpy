label event_2:
    menu:
        "먹는다":
            ...
            # --- 2. 자유 대화 1: 메뉴 주문 ---
            $ talk_loop("suah", "너의 역할은 수아야. 햄버거 가게에 도착해서 메뉴를 고르고 주문하는 상황에서 수아가 뭐 먹을지 물어본 상황이다./ 플레이어가 뭘 먹을지 결정하면 종료된다.")
            ...
            # --- 4. 자유 대화 2: 방과 후 일정 ---
            $ talk_loop_all_charactor("음식을 먹으며 방과 후 일정에 대해 이야기하는 상황이다. 플레이어의 말에 따라 호감도를 -3에서 +2 사이로 변경하며 반응하라./ 일정에 대한 대화를 3~5턴 정도 진행하면 종료된다.")
            hide suah normal
            jump talk_3
